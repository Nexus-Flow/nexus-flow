...
import com.nexus_flow.core.sagas.domain.OneSagaCommand;
...
public class TriggeredByCommandSagaHandler extends SagaHandler {

    public TriggeredByCommandSagaHandler(SagaRepository repository) {
        super(new SagaType(
