...
public final class ScheduledCommandDuplicateException extends RuntimeException {
    ...
    public ScheduledCommandDuplicateException(ScheduledCommandId id) {
        // Stack-traceless — idempotent scheduling catches this as a benign signal. Saves
        // ~200 ns per duplicate throw on the dedup hot path.
        super(
              "scheduled command already exists: " + id,
              /* cause= */ null,
