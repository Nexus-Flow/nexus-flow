...
public class TypeReferenceVariable<D extends GenericDeclaration> implements TypeVariable<D> {
    ...
    /**
     * Non-defensive view of the upper bounds — returns the internal array WITHOUT a copy.
     * The caller MUST treat the array as immutable. Intended for framework hot paths; library
     * users that need the JDK contract use {@link #getBounds()}.
     */
    @SuppressWarnings("PMD.MethodReturnsInternalArray")
    public Type[] boundsUnsafe() {
        return bounds;
    }
    ...
    /**
     * Non-defensive view of the annotated bounds — returns the internal array WITHOUT a copy.
     * The caller MUST treat the array as immutable. Intended for framework hot paths; library
     * users that need the JDK contract use {@link #getAnnotatedBounds()}.
     */
    @SuppressWarnings("PMD.MethodReturnsInternalArray")
    public AnnotatedType[] annotatedBoundsUnsafe() {
