...
public record SagaRunnerConfig(
                               long batchSize, long startGlobalPosition, Clock clock, @Nullable OutboxPayloadCodec codec) {
    ...
    public static final SagaRunnerConfig DEFAULTS =
            new SagaRunnerConfig(
                    DEFAULT_BATCH_SIZE, EventStore.FIRST_GLOBAL_POSITION, Clock.systemUTC(), null);
    ...
    public static final class Builder {
        ...
        public SagaRunnerConfig build() {
            return new SagaRunnerConfig(batchSize, startGlobalPosition, clock, codec);
        }
    }
}
