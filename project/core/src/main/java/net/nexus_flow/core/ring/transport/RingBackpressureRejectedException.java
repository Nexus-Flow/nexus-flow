...
public final class RingBackpressureRejectedException extends RuntimeException {
    ...
    public RingBackpressureRejectedException(
        ...
        // Stack-traceless — diagnostics travel in the message + peerId/queueDepth/capacity
        // accessors. Stack trace at rejection points to RingConnection.send, not the
        // overload origin. Saves ~200 ns per rejection on the saturated-peer hot path.
        super(
