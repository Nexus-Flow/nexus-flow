...
public final class OptimisticConcurrencyException extends RuntimeException {
    ...
    public OptimisticConcurrencyException(StreamId stream, long expectedVersion, long actualVersion) {
        // Stack-traceless — optimistic-concurrency conflicts are the documented retry/rebase
        // path under contention. Stack trace at the conflict points to AggregateRepository.save,
        // not the contention origin. Saves ~200 ns per conflict throw.
        super(
