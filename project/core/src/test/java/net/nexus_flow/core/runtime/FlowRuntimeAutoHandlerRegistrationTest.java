 ...
 * — the DX shortcut that lets callers wire handlers / listeners / query handlers without touching
 * the bus accessors explicitly. The audit identified this as the canonical missing piece between
 * "framework wired" and "demo-runnable".
 */
