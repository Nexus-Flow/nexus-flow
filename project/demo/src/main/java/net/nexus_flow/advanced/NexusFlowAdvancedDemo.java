...
public final class NexusFlowAdvancedDemo {
    ...
    public static void main(String[] args) {
        ...
        PlaceOrderHandler placeHandler = new PlaceOrderHandler(outboxStorage);
        StockService     stockListener = new StockService(placeHandler.orders(),
                                                          outboxStorage,
                                                          /* tries before first failure */ 1);
        ...
        try (FlowRuntime runtime = FlowRuntime.builder()
            ...
            // Give the outbox worker a chance to drain before shutdown logs.
            try {
                Thread.sleep(500L);
